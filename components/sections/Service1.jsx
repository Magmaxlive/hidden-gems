...
export default function Service1() {
    useEffect(() => {
        const tabs = document.querySelectorAll('.service1-tab-wrap li');
        tabs.forEach(tab => {
    ...
    const handleTabMouseEnter = (event) => {
        ...
        if (targetContent) {
            ...
            document.querySelectorAll('.service1-tab-content').forEach(content => content.style.display = 'none');
