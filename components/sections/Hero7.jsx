                        ...
                        <div className="col-lg-12">
                            <div className="hero-style7">
                                <h1 className="hero-title wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                    WE CREATE REMARKABLE AND EXCITING DIGITAL ADVENTURES <img src="/assets/img/hero/hero-7-1.jpg" alt="img"/>
                                </h1>
                                <div className="hero-flex-wrap">
                                    ...
                                    <p className="hero-text wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">Beautiful design has the power to captivate audiences. Hidden Gems specializes in creating stunning designs.</p>
