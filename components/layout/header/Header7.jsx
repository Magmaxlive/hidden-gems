...
export default function Header7({ scroll, isMobileMenu, handleMobileMenu, isOffcanvasMenu, handleOffcanvasMenu }) {
    return (<>
            <header>
            <div id="sticky-header" className={`tg-header__area transparent-header tg-header__area-seven ${scroll ? "sticky-menu" : ""}`}>
                    ...
                    <nav className="tgmobile__menu-box">
                        ...
                        <div className="tgmobile__menu-bottom">
                            <div className="contact-info">
                                <ul className="list-wrap">
                                    <li><Link href="mailto:info@Hidden Gems.com">info@Hidden Gems.com</Link></li>
