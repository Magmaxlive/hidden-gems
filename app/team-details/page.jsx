                                ...
                                <div className="col-lg-6">
                                    <div className="team-details-about-info mb-0">
                                        ...
                                        <div className="team-contact-wrap mt-30">
                                            <h6 className="team-contact-title mb-20"><span className="me-2">EMAIL:</span> <Link href="mailto:matilda.Hidden Gems@mail.com">matilda.Hidden Gems@mail.com</Link></h6>
