...
export default function Faq() {
    return (<>
            ...
            <Layout headerStyle={2} footerStyle={2} breadcrumbTitle="FAQs">
                <div>
                                                ...
                                                <div className="col-xl-7">
                                                    <div className="testimonial__item style4">
                                                        ...
                                                        <div className="testimonial__content">
                                                            <p className="testimonial__text">Hidden Gems has been an invaluable partner to us. Any talent we've worked with has shown a deep
